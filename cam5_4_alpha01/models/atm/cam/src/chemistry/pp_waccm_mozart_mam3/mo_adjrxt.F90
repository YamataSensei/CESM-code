...
!--------------------------------------------------------------------
      real(r8) :: im(ncol,pver)
         ...
         rate(:,:, 77) = rate(:,:, 77) * inv(:,:, 1)
         rate(:,:, 80) = rate(:,:, 80) * inv(:,:, 2)
         rate(:,:, 86) = rate(:,:, 86) * inv(:,:, 2)
         rate(:,:, 88) = rate(:,:, 88) * inv(:,:, 2)
         rate(:,:,114) = rate(:,:,114) * inv(:,:, 1)
         rate(:,:,118) = rate(:,:,118) * inv(:,:, 1)
         rate(:,:,120) = rate(:,:,120) * inv(:,:, 1)
         rate(:,:,121) = rate(:,:,121) * inv(:,:, 1)
         rate(:,:,122) = rate(:,:,122) * inv(:,:, 1)
         rate(:,:,128) = rate(:,:,128) * inv(:,:, 1)
         ...
         rate(:,:,229) = rate(:,:,229) * inv(:,:, 2)
         rate(:,:,238) = rate(:,:,238) * inv(:,:, 2)
         rate(:,:, 75) = rate(:,:, 75) * m(:,:)
         rate(:,:, 76) = rate(:,:, 76) * m(:,:)
         rate(:,:, 77) = rate(:,:, 77) * m(:,:)
         rate(:,:, 78) = rate(:,:, 78) * m(:,:)
