...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 74, & ! number of photolysis reactions
                            rxntot = 242, & ! number of total reactions
                            gascnt = 168, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 78, & ! number of "gas phase" species
                            nfs = 2, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 527, & ! number of non-zero matrix entries
                            extcnt = 18, & ! number of species with external forcing
                            clscnt1 = 17, & ! number of species in explicit class
                            clscnt2 = 0, & ! number of species in hov class
                            clscnt3 = 0, & ! number of species in ebi class
                            clscnt4 = 61, & ! number of species in implicit class
